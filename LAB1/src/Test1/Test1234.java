...
public void MassTest(){
	Variant13 main_object=new Variant13();
...
public void boolean_test(int a,int b ,boolean res) {
	assertEquals(new Variant13().booleantask(a,b), res);
}
////////////////////////////////////////IfTest////////////////////////////////////////////////////////////////////////////////
@DataProvider
...
public void if_test(int a,int b,int res) {
	assertEquals(new Variant13().iftask(a,b),main.new ClassForIfTask(res,res));
}
//////////////////////////////////////////CaseTest///////////////////////////////////////////////////////////////////
@DataProvider
