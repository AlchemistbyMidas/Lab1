...
public class Variant13 {
	public class ClassForBeginTask{
		private double sum;
		...
		public ClassForBeginTask(double a, double b ,double c ,double d ,double e){
			sum=a;
			difference=b;
			multiplication=c;
			division1=d;
...
public class ClassForIfTask{
		private int returneda,returnedb;
		ClassForIfTask(){
			returneda=0;
			returnedb=0;
		}
		public ClassForIfTask(int a,int b){
			returneda=a;
			returnedb=b;
		}
	...
	public class ClassForIntegerNumberTask{
		private int sum,mul;
		ClassForIntegerNumberTask(){
			sum=0;
			mul=1;
		}
		public ClassForIntegerNumberTask(int a, int b){
			sum=a;
			mul=b;
		}
